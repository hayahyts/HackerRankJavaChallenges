...
class DateUtilsTest {
    ...
    void giveSameDate_whenCalculateDaysCalled_returnZero() {
        // Test same day
        int totalDays = ImprovedDateUtils.calculateDurationInDays(14, 8, 2017);
        assert (totalDays == 0);
    }
    ...
    void givenFutureYear_whenCalculateDaysCalled_returnPositiveDays() {
        // Test Year
        int totalDays3 = ImprovedDateUtils.calculateDurationInDays(14, 9, 2018);
    ...
    void givenFutureLeapYear_whenCalculateDaysCalled_returnPositiveDays() {
        // Test Year
        int totalDays3 = ImprovedDateUtils.calculateDurationInDays(14, 8, 2020);
    ...
    void givenFutureDay_whenCalculateDaysCalled_returnPositiveDays() {
        // Test Day
        int totalDays1 = ImprovedDateUtils.calculateDurationInDays(15, 8, 2017);
        assert (totalDays1 == 1);
    }
    ...
    void givenFutureMonth_whenCalculateDaysCalled_returnPositiveDays() {
        // Test Month
        int totalDays2 = ImprovedDateUtils.calculateDurationInDays(14, 9, 2017);
    ...
    void givenFutureDayAndMonth_whenCalculateDaysCalled_returnPositiveDays() {
        // Test Day and Month
        int totalDays4 = ImprovedDateUtils.calculateDurationInDays(15, 9, 2017);
    ...
    void givenFutureMonthAndYear_whenCalculateDaysCalled_returnPositiveDays() {
        // Test Month and Year
        int totalDays5 = ImprovedDateUtils.calculateDurationInDays(14, 9, 2018);
    ...
    void givenFutureDate_whenCalculateDaysCalled_returnPositiveDays() {
        ...
        int totalDays6 = ImprovedDateUtils.calculateDurationInDays(7, 4, 2021);
    ...
    void givenPrevDay_whenCalculateDaysCalled_returnNegativeDays() {
        // Test Day
        int totalDays1 = ImprovedDateUtils.calculateDurationInDays(12, 8, 2017);
        assert (totalDays1 == -2);
    }
    ...
    void givenPrevMonth_whenCalculateDaysCalled_returnNegativeDays() {
        // Test Month
        int totalDays2 = ImprovedDateUtils.calculateDurationInDays(14, 7, 2017);
        assert (totalDays2 == -31);
    }
    ...
    void givenPrevYear_whenCalculateDaysCalled_returnNegativeDays() {
        // Test Year
        int totalDays3 = ImprovedDateUtils.calculateDurationInDays(1, 3, 2016);
    ...
    void givenPrevDayAndMonth_whenCalculateDaysCalled_returnNegativeDays() {
        // Test Day and Month
        int totalDays = ImprovedDateUtils.calculateDurationInDays(15, 7, 2017);
        assert (totalDays == -30);
    }
    ...
    void givenPrevMonthAndYear_whenCalculateDaysCalled_returnNegativeDays() {
        // Test Day and Month
        int totalDays = ImprovedDateUtils.calculateDurationInDays(14, 7, 2016);
    ...
    void givenPrevDate_whenCalculateDaysCalled_returnNegativeDays() {
        // Test Day and Month
        int totalDays = ImprovedDateUtils.calculateDurationInDays(13, 7, 2016);
        assert (totalDays == -397);
    }

    @Test
    void givenPositiveDays_whenGetDayOfWeekCalled_returnRightName() {
        String dayName0 = ImprovedDateUtils.getDayOfWeek(0);
        assert (dayName0.equals("MONDAY"));

        String dayName1 = ImprovedDateUtils.getDayOfWeek(1);
        assert (dayName1.equals("TUESDAY"));

        String dayName3 = ImprovedDateUtils.getDayOfWeek(967);
        assert (dayName3.equals("TUESDAY"));
    }

    @Test
    void givenNegativeDays_whenGetDayOfWeekCalled_returnRightName() {
        String dayName0 = ImprovedDateUtils.getDayOfWeek(-1);
        assert (dayName0.equals("SUNDAY"));

        String dayName1 = ImprovedDateUtils.getDayOfWeek(-2);
        assert (dayName1.equals("SATURDAY"));

        String dayName2 = ImprovedDateUtils.getDayOfWeek(-8);
